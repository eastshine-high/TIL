...
먼저 리소스를 식별합니다. 리소스는 회원을 등록하고 수정하고 조회하는 것이 아닙니다. **회원**이라는 개념 자체가 바로 리소스입니다. REST URI는 동사 대신 명사를 사용해 리소스를 나타내야 합니다. 이는 동사엔 없는 명사의 성질 때문인데, 이 성질은 리소스의 성질과도 유사합니다.
